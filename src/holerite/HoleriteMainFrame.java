...
/**
 *
 * @author andre.qpatrinicola
 */
public class HoleriteMainFrame extends javax.swing.JFrame {

    /**
     * Creates new form HoleriteMainFrame
     */
    public HoleriteMainFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jCheckBox1.setText("Vale Refeição");
        ...
        jCheckBox2.setText("Vale Alimentação");
        ...
        jCheckBox4.setText("Convênio Médico");
        ...
        jLabel1.setText("Calculador Holerite");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HoleriteMainFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HoleriteMainFrame().setVisible(true);
            }
        });
    }
